...
// import 'Services/battery_sync.dart';  // ✅ ADD THIS IMPORT
...
Future<void> _capturePendingShutdownTime() async {
  ...
  try {
    ...
    // ── Insert directly into local DB — event_time is fixed here and never
    // changes again, regardless of when the sync eventually succeeds. ──
    ...
    // ── Immediately try to sync (no-op safely if offline — row stays in DB) ──
