...
import 'ViewModels/attendance_view_model.dart'; // ← ADD THIS
import 'ViewModels/attendance_out_view_model.dart'; // ← ADD THIS
import 'ViewModels/location_view_model.dart'; // ← ADD THIS
...
Future<void> main() async {
  ...
  Get.put(LocationViewModel(), permanent: true); // ← ADD THIS
  Get.put(AttendanceViewModel(), permanent: true); // ← ADD THIS
  Get.put(AttendanceOutViewModel(), permanent: true); // ← ADD THIS
  Get.put(TravelViewModel(), permanent: true); // ← ADD THIS (depends on above)
