...
//
//   // ── Call once in main() or when HomeScreen mounts ─────────────────────────
//   //
//   //   FakeGpsLog.startConnectivityListener();
//   //
//   // Whenever the device comes back online it will drain every unsynced row.
...
//
//     // ── Get REAL location by forcing hardware GPS (bypasses mock) ────────────
//     double realLat = 0.0;
//     double realLon = 0.0;
//     try {
//       Position? realPos;
...
//     final realAddress =
//     realLat != 0.0 ? await _getAddress(realLat, realLon) : 'Unknown';
//
//     // ── Distance (km) ─────────────────────────────────────────────────────────
//     final distanceKm = realLat != 0.0
//         ? Geolocator.distanceBetween(realLat, realLon, fakeLat, fakeLon) /
//         1000.0
//         : 0.0;
//
//     debugPrint(
...
//       empName:
//       _pref(prefs, 'emp_name', fallbacks: ['empName', 'employee_name', 'userName']),
