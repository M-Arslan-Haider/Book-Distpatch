...
// ✅ FIX: Use full epoch ms (not % 1000) to guarantee uniqueness across exits
    final serial   = out_time.millisecondsSinceEpoch.toString();
...
// ✅ FIX: Guard against duplicate exit trigger (isOutside already true = already processing)
    if (violations.any((v) => v.violation_id == violation_id)) {
      debugPrint('⚠️ [GeofenceVM] Duplicate exit ignored: $violation_id');
      return;
    }
