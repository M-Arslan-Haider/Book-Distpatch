...
class BreakViewModel extends GetxController {
  ...
  Future<void> fetchScheduledBreakTime() async {
    try {
      ...
      final attendanceDataEndpoint = RemoteConfigService.getAttendanceDataUrl(_userId);
      final url = Uri.parse(attendanceDataEndpoint).replace(queryParameters: {'user_id': _userId});
