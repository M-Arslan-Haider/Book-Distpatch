...
// //       attendance_out_id: attendanceOutId,  // ✅ SAME ID AS ATTENDANCE IN
// //       emp_id: empId,
...
// //     );
// //
// //     debugPrint('📊 [OutVM] Using attendance_in_id: $attendanceOutId | dist=${finalDistance.toStringAsFixed(3)} km | time=$totalTime');
// //
...
// //         timeStr = (jsonDecode(blob) as Map<String, dynamic>)['fast_clockOutTime'] as String?;
// //       }
// //
...
// //       debugPrint(
// //           '📊 ID=${r.attendance_out_id} | dist=${r.total_distance} km | time=${r.total_time} | posted=${r.posted} | company=${r.company_code}');
// //     }
// //   }
// //
...
//     }
//
//     // ✅ Get current location for reverse geocoding
...
//     final String humanAddress = await _getAddressFromLatLng(currentLat, currentLng);
//
//     // ✅ Get location name for geofencing users
...
//       address: address,
//       location_name: locationName,  // ✅ ADDED - geofencing location name
//       reason: reason,
//       attendance_out_time: outTime,
//       attendance_out_date: outTime,
//       posted: 0,
...
//
//     debugPrint('📊 [OutVM] Using attendance_in_id: $attendanceOutId | dist=${finalDistance.toStringAsFixed(3)} km | time=$totalTime');
//     debugPrint('📍 [OutVM] Address: $humanAddress');
...
//     double latOut = _locVM.globalLatitude1.value;
//     double lngOut = _locVM.globalLongitude1.value;
//     String humanAddress = _locVM.shopAddress.value;
//
//     try {
//       final currentPosition = await Geolocator.getCurrentPosition(
//         desiredAccuracy: LocationAccuracy.high,
...
//       _locVM.globalLongitude1.value = lngOut;
//
//       // ✅ Get fresh address for fast clock-out
...
//       'fast_location_name': locationName,  // ✅ ADDED
//       'fast_reason': reason,
//       'fast_savedAt': DateTime.now().millisecondsSinceEpoch.toString(),
//       'fast_company_code': DBHelper.getCompanyCode(),
//     };
...
//           location_name: locationName,  // ✅ ADDED
//           reason: reason,
//           attendance_out_time: clockOutTime,
//           attendance_out_date: clockOutTime,
//           posted: 0,
...
//     for (final r in records) {
//       debugPrint(
//           '📊 ID=${r.attendance_out_id} | dist=${r.total_distance} km | time=${r.total_time} | posted=${r.posted} | company=${r.company_code} | location_name=${r.location_name}');
//     }
//   }
//
//   Future<int> todayClockOutsCount() async {
...
//       'backup_lngOut': _locVM.globalLongitude1.value,
//       'backup_address': address,
//       'backup_location_name': locationName,  // ✅ ADDED
//       'backup_reason': reason,
//       'backup_savedAt': DateTime.now().toIso8601String(),
//       'backup_company_code': DBHelper.getCompanyCode(),
//     };
