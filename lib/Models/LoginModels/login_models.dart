...
class LoginModels {
  ...
  String? geo_fencing;
  String? company_code;
  String? dep_id;  // Added dep_id field
  ...
  LoginModels({
    ...
    this.geo_fencing,
    this.company_code,
    this.dep_id,  // Added dep_id parameter
    this.end_time,
    this.over_time,
    this.shift,
    this.image_url,
  ...
  factory LoginModels.fromJson(Map<String, dynamic> json) {
    ...
    return LoginModels(
      ...
      dep_id: json['dep_id']?.toString() ?? json['DEP_ID']?.toString(),  // Added dep_id mapping
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'DEP_ID': dep_id,  // Added dep_id to JSON output
      'END_TIME': end_time,
      'OVER_TIME': over_time,
      'SHIFT': shift,
      'image_url': image_url,
