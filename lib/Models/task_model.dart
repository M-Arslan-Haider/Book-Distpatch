...
class TaskModel {
  ...
  factory TaskModel.fromJsonSafe(
    ...
    return TaskModel(
      ...
      taskType:        v(json, 'task_type')?.toString()          ?? 'SELF',
      category:        v(json, 'category')?.toString()           ?? '',
      company_code:    v(json, 'company_code')?.toString(), // ← ADDED
    );
  }
  ...
  factory TaskModel.fromJson(Map<String, dynamic> json) {
    ...
    return TaskModel(
      ...
      taskType:        val('task_type')?.toString()          ?? 'SELF',
      category:        val('category')?.toString()           ?? '',
      company_code:    val('company_code')?.toString(), // ← ADDED
    );
  }
  ...
  @override
  String toString() =>
      'TaskModel(id: $id, empId: $empId, title: $taskTitle, status: $status, company: $company_code)';
}
...
class UpdateTaskRequest {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (company_code != null && company_code!.isNotEmpty) {
      json['company_code'] = company_code; // ← ADDED
    }
