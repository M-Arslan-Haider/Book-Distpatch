// // lib/Screens/breaks_screen.dart
// //
// // BreaksScreen — Breaks tab ka main hub.
// // • Top: Navbar (teal gradient, same as home)
// // • Bottom: AppBottomNavBar (Breaks tab active = index 5)
// // • Body: TabBar with "Lunch Break" and "Short Breaks" tabs
// //   – Lunch Break tab  → inline lunch break UI (BreakViewModel)
// //   – Short Breaks tab → pushes ShortBreakScreen (ShortBreakViewModel)
//
...
//   late final BreakViewModel _vm;
//
//   @override
//   void initState() {
//     super.initState();
//     _tabController = TabController(length: 2, vsync: this);
//     _vm = Get.put(BreakViewModel());
//
...
//       // ── Top navbar ───────────────────────────────────────────────────────
//       appBar: _BreaksAppBar(tabController: _tabController),
//       // ── Body: two tab views ──────────────────────────────────────────────
//       body: TabBarView(
//         controller: _tabController,
//         children: [
//           _LunchBreakTab(vm: _vm),
//           _ShortBreaksTab(),
//         ],
//       ),
//       // ── Bottom navbar ────────────────────────────────────────────────────
...
//
// // ══════════════════════════════════════════════════════════════════════════════
// // APP BAR — teal gradient + TabBar
// // ══════════════════════════════════════════════════════════════════════════════
// class _BreaksAppBar extends StatelessWidget implements PreferredSizeWidget {
//   final TabController tabController;
//   const _BreaksAppBar({required this.tabController});
//
//   static const Color _tealLight = Color(0xFF3DAF93);
//   static const Color _tealDark  = Color(0xFF1A6E59);
//
//   // Fixed height: title row (56) + tab bar (44) + spacing (12) + bottom pad (8)
//   @override
...
//           Positioned(
//             bottom: 20, left: -15,
//             child: _circle(80, Colors.white, 0.05),
//           ),
//           // SafeArea handles status bar automatically
//           SafeArea(
//             bottom: false,
//             child: Column(
...
//                             ),
//                             Text(
//                               'Lunch and short break management',
//                               style: TextStyle(
...
//                             mainAxisAlignment: MainAxisAlignment.center,
//                             children: [
//                               Icon(Icons.coffee_rounded, size: 14),
//                               SizedBox(width: 5),
//                               Text('Short Breaks'),
//                             ],
//                           ),
...
// }
//
// // ── Summary card (same style as screenshot) ───────────────────────────────────
...
//
// // ══════════════════════════════════════════════════════════════════════════════
// // SHORT BREAKS TAB — navigate karo ShortBreakScreen par
// // ══════════════════════════════════════════════════════════════════════════════
// class _ShortBreaksTab extends StatelessWidget {
//   const _ShortBreaksTab();
//
//   @override
//   Widget build(BuildContext context) {
//     // Seedha push karo — tab ko screen pe replace karne ki zaroorat nahi
//     // Yeh ek "launcher" tile hai jo user ka experience clear rakhti hai
//     return Center(
//       child: Padding(
...
//             const SizedBox(height: 10),
//             Text(
//               'Tea breaks, smoke breaks aur baaki short breaks yahan se start aur end karein.',
...
// • Body: TabBar with "Lunch Break" and "Short Breaks" tabs
//   – Lunch Break tab  → inline lunch break UI (BreakViewModel)
//   – Short Breaks tab → inline short breaks UI (no separate screen)
