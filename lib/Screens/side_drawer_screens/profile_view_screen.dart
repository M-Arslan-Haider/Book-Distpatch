...
class _EmployeeProfileScreenState extends State<EmployeeProfileScreen>
  ...
  Future<void> _fetchEmployee() async {
    ...
    try {
      ...
      final uri = Uri.parse('$_baseUrl/empinfo/get').replace(queryParameters: {
        'emp_id': _resolvedId,
        'company_code': _companyCode,
      });
  ...
  // ============================================================
  // ALL YOUR EXISTING HELPER METHODS AND UI CODE BELOW
  // (keep everything exactly as is - _v, getters, _buildAppBar,
  //  _buildAvatar, _buildProfile, _card, _pair, _full, _cell,
  //  _color, _btn, _logout, etc.)
  // ============================================================
