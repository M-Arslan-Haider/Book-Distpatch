...
class _AttendanceReportScreenState extends State<AttendanceReportScreen>
  ...
  Future<void> _fetchAttendance() async {
    ...
    try {
      ...
      // ✅ UPDATED: Using Remote Config base URL
      final uri = Uri.parse('$_baseUrl/attendancedata1/get').replace(queryParameters: {
        'emp_id':       _resolvedId,
        'company_code': companyCode,
      });
  ...
  // Rest of the file remains the same (filter methods, UI builders, etc.)
  // ... (keep all your existing UI code below - _applyFilter, _clearFilter,
  //     _buildAppBar, _buildContent, etc. - they don't need changes)
