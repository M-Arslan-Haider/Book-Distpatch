...
//         }
//
//         // Debug: print all keys from first record to identify exact field names
...
//   ]);
//
//   // ── ADDRESS — all possible casings Oracle ORDS might return ───────────────
...
//   ]);
//
//   // ── TOTAL_TIME_FOR_THE_DAY — daily total from SQL subquery ────────────────
...
//   }
//
//   // ── Format date: "2026-02-09" → "Mon, Feb 9" ──────────────────────────────
...
//     if (mins <= 0) return raw; // return raw if parsing fails
...
//
//         // Use TOTAL_TIME_FOR_THE_DAY from API (same value for all records of a day)
...
//
//   // ── Date header row ────────────────────────────────────────────────────────
//   // Left: "Mon, Feb 9"    Right: TOTAL_TIME_FOR_THE_DAY e.g. "7h 15m"
//
...
//   }
//
//   // ── Record card — matches reference image exactly ──────────────────────────
//   // Left  : ADDRESS (primary bold)
//   //         emp_name · emp_id (small muted, below)
//   // Right : TOTAL_TIME bold top
//   //         "IN - OUT" muted below
//
...
//         '${inT != '—' ? inT : '?'}  -  ${outT != '—' ? outT : '?'}';
//
//     // Primary label shown on the left (address if available, else emp name)
//     final primaryLabel =
//     addr != '—' ? addr : (empName != '—' ? empName : 'Unknown');
//
//     // Sub label shown below primary (only when address is available)
...
//               children: [
//                 // ADDRESS (matches "CH Abdul Hameed Pe..." / "Office" in image)
//                 Text(
//                   primaryLabel,
//                   style: const TextStyle(
//                     fontSize: 14,
...
//             children: [
//               // TOTAL_TIME bold — matches "7h 57m" in image
//               Text(
//                 duration,
//                 style: TextStyle(
//                   fontSize: 14,
...
//               ),
//               const SizedBox(height: 3),
//               // "9:03 AM - 5:00 PM" muted — matches image
//               Text(
//                 timeRange,
//                 style: const TextStyle(
//                   fontSize: 11,
