...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  // ══════════════════════════════════════════════════════════════════════════
  // SHORT BREAK ACTION TILE — compact Quick Actions tile (2×2 grid)
  // ══════════════════════════════════════════════════════════════════════════
  Widget _shortBreakActionTile(double tileHeight) {
    final iconBoxSize = context.rs(44);
    final iconSize    = context.rs(22);
    const color       = Color(0xFFE07B39); // warm orange — distinct from Break
    ...
    return Obx(() {
      ...
      return Expanded(
        child: GestureDetector(
          onTap: () {
            // ── Clock-in guard: Short Break is only available while clocked in ──
