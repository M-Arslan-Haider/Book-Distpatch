...
//   bool _routesActive = false;
//
//   // ── Scaffold key — needed for Navbar drawer ────────────────────────────
//   final GlobalKey<ScaffoldState> _scaffoldKey = GlobalKey<ScaffoldState>();
//
//   // ── User info — loaded from SharedPreferences ──────────────────────────
...
//         prefs.getString('empName')    ?? 'Employee';
//     setState(() {
//       _empName     = name;
...
//           const SizedBox(height: 16),
//
//           // ── Calendar — shown only for Weekly / Monthly ─────────────────
//           if (_selectedPeriod == 'Weekly' || _selectedPeriod == 'Monthly') ...[
//             Padding(
//               padding: const EdgeInsets.symmetric(horizontal: 20),
//               child: _buildCalendarPicker(),
        ...
        decoration: BoxDecoration(
          gradient: filled
            ...
            begin: Alignment.topLeft,
              ...
              : null,
          color: filled ? null : AppColors.primary.withOpacity(0.10),
          borderRadius: BorderRadius.circular(11),
          boxShadow: filled
              ? [
            BoxShadow(
