...
///offline
// ═══════════════════════════════════════════════════════════════════════════
// no_sale_visit_controller.dart - Updated with offline support
// ═══════════════════════════════════════════════════════════════════════════
...
class NoSaleVisitController extends GetxController {
  ...
  static const int _targetMaxBytes = 100 * 1024;
  ...
  //============= SUBMIT =============
  // no_sale_visit_controller.dart mein submitVisit method ko replace karein:
  ...
  Future<bool> submitVisit() async {
    ...
    try {
      ...
      if (result.success) {
        developer.log('✅ Visit saved: ${result.visitId ?? model.visitId}',
            name: 'NoSaleVisitController');
        model.errorMessage = null;
        return true;
      } else {
