// // ═══════════════════════════════════════════════════════════════════════════
// // no_sale_visit_model.dart
// //
// // Data model for the "No Sale of Stock" flow:
// //   ShopVisitOutcomeScreen -> NoSaleShopSelectScreen (pick shop, fetch data)
// //   -> NoSaleStockScreen (pick products, ONLY quantity — no discount/bonus,
// //      capture shop photo + GPS) -> submit
// //
// // Posts to the SAME endpoint as the booking flow:
// //   POST http://oracle.metaxperts.net/ords/gps_workforce/shop_visit/post/
// // but with visit_type = 'Shop Visit', and PRICE left as the catalog price
// // (no discount math — this flow just logs stock present at the shop).
// // ═══════════════════════════════════════════════════════════════════════════
//
