...
import 'package:book_dispatch/Screens/Order%20and%20Dispatch/screens/shop_visit_screen.dart';
...
class OrderScreen extends StatefulWidget {
  ...
  const OrderScreen({
    super.key,
    this.currentIndex = 6, // Order tab index in _allTabs
...
class _OrderScreenState extends State<OrderScreen> {
  ...
  static const _actions = [
    ...
    _QuickAction(
      label:    'Shop Visit',
      subtitle: 'Log a shop visit',
      icon:     Icons.storefront_rounded,
      color:    Color(0xFF2563EB),
      accent:   Color(0xFFEFF6FF),
      route:    '/orderShopVisit',
    ),
    _QuickAction(
      label:    'Dispatch',
      subtitle: 'Dispatch an order',
...
class _ActionCardState extends State<_ActionCard>
  ...
  void _onTap() {
    ...
    if (widget.action.route == '/orderAddShop') {
      Get.to(() => const AddShopScreen());
    } else if (widget.action.route == '/orderShopVisit') {
      Get.to(() => const ShopVisitScreen());
    } else if (widget.action.route == '/orderDispatch') {
      // TODO: Get.to(() => const DispatchScreen());
    }
  }
