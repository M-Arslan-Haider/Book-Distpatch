...
//                               textAlign: TextAlign.center, // text bhi center align ho jaye
//                               style: TextStyle(
//                                 fontSize: 14,
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'This app needs location access to track attendance and monitor workforce movement even when the app is in background.',
                          ...
                          SizedBox(
                            ...
                            child: DecoratedBox(
                              ...
                              child: ElevatedButton(
                                onPressed: () async {
                                  // First request regular location
                                  PermissionStatus status = await Permission.location.request();

                                  if (status.isGranted) {
                                    // Then request "Always" permission (important for background tracking)
                                    ...
                                    if (alwaysStatus.isGranted) {
                                      ...
                                      Get.snackbar(
                                        'Permission Denied',
                                        'Please allow "Always" location from Settings.',
                                        snackPosition: SnackPosition.BOTTOM,
                                        backgroundColor: AppColors.error,
                                        colorText: Colors.white,
