...
//         debugPrint('⚠️ [END TIME] emp_id or company_code missing');
//         return null;
//       }
//
//       final uri = Uri.parse(
//         'http://oracle.metaxperts.net/ords/gps_workforce/endtime/get/'
//             '?emp_id=$empId&company_code=$companyCode',
//       );
//
//       debugPrint('🌐 [END TIME] Fetching: $uri');
//
...
//       debugPrint('📥 [END TIME] Response: $body');
//
//       // Parse JSON — expected: { "end_time": "17:30:00" } or similar
//       final decoded = _parseEndTimeJson(body);
//       if (decoded == null) return null;
//
//       // Build a DateTime for today using the returned HH:mm:ss
//       final now   = DateTime.now();
...
//     } catch (e) {
//       debugPrint('❌ [END TIME] Error: $e');
//       return null;
//     }
//   }
//
//   /// Tries to extract the end-time string from a raw JSON body.
//   /// Handles fields: end_time, endTime, end_hour, shift_end, time.
//   String? _parseEndTimeJson(String body) {
//     for (final key in ['end_time', 'endTime', 'end_hour', 'shift_end', 'time']) {
//       final value = _extractJsonValue(body, key);
