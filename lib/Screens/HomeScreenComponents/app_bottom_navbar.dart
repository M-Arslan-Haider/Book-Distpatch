...
// // import '../Visit List/customer_list_screen.dart';
...
// // import '../Visit List/visits_list_screen.dart';
// // import '../Visit List/followups_list_screen.dart';
// //
// // // ═══════════════════════════════════════════════════════════════════════════
...
// //     _NavTab(icon: Icons.people_outline,          activeIcon: Icons.people,               label: 'Customers'),
// //     _NavTab(icon: Icons.route_outlined,          activeIcon: Icons.route_rounded,        label: 'Visits'),
// //     _NavTab(icon: Icons.event_repeat_outlined,   activeIcon: Icons.event_repeat_rounded, label: 'Follow-ups'),
// //     _NavTab(icon: Icons.timer_outlined,          activeIcon: Icons.timer_rounded,        label: 'TimeKeeper', isTimekeeper: true),
// //   ];
// //
// //   static const int _maxTabs = 10; // allocate controllers for all tabs
// //
...
// //         context,
// //         PageRouteBuilder(
// //           pageBuilder: (context, animation, secondaryAnimation) => CustomersListScreen(
// //             currentIndex: 6,
// //             chatBadgeCount: widget.chatBadgeCount,
// //             onNavTap: (i) {
// //               if (navigator.canPop()) navigator.pop();
...
// //         context,
// //         PageRouteBuilder(
// //           pageBuilder: (context, animation, secondaryAnimation) => VisitsListScreen(
// //             currentIndex: 7,
// //             chatBadgeCount: widget.chatBadgeCount,
// //             onNavTap: (i) {
// //               if (navigator.canPop()) navigator.pop();
...
// //     }
// //
// //     // ── Follow-ups tab (index 8) ────────────────────────────────────────────
// //     if (allTabIndex == 8) {
// //       if (widget.currentIndex == 8) return;
// //       final navigator = Navigator.of(context, rootNavigator: true);
// //       Navigator.push(
// //         context,
// //         PageRouteBuilder(
// //           pageBuilder: (context, animation, secondaryAnimation) => FollowupsListScreen(
// //             currentIndex: 8,
// //             chatBadgeCount: widget.chatBadgeCount,
// //             onNavTap: (i) {
// //               if (navigator.canPop()) navigator.pop();
...
// //
// // TimeKeeper tab shown only when LoginViewModel.isTimekeeper == true.
// // Order/Booking tab added at index 6 (before TimeKeeper).
// // Customers, Visits, Follow-ups tabs are HIDDEN.
// // ═══════════════════════════════════════════════════════════════════════════
//
// class AppBottomNavBar extends StatefulWidget {
//   final int currentIndex;
...
//   // 5: Company
//   // 6: Booking/Order
//   // 7: TimeKeeper (conditional)
//   //
//   // NOTE: Customers, Visits, Follow-ups are REMOVED from _allTabs
//
//   static const _allTabs = [
//     _NavTab(icon: Icons.home_outlined,           activeIcon: Icons.home_rounded,        label: 'Home'),
//     _NavTab(icon: Icons.bolt_outlined,           activeIcon: Icons.bolt_rounded,         label: 'Actions'),
...
//   ];
//
//   static const int _maxTabs = 8; // allocate controllers for all tabs
//
//   late final List<AnimationController> _pressControllers;
//   late final List<Animation<double>>   _pressAnimations;
//   late final List<AnimationController> _bubbleControllers;
...
import '../TimeKeeper/time_keeper.dart';
import '../Order and Dispatch/screens/booking_screen.dart';
import '../Order and Dispatch/screens/dispatch_screen.dart';
import '../actions_screen.dart';
import '../break_screen.dart';
import '../schedule_hub_screen.dart';
import '../../ViewModels/login_view_model.dart';
...
class _AppBottomNavBarState extends State<AppBottomNavBar>
  ...
  static const _allTabs = [
    ...
    _NavTab(icon: Icons.business_outlined,       activeIcon: Icons.business_rounded,     label: 'Company'),
    _NavTab(icon: Icons.shopping_bag_outlined,   activeIcon: Icons.shopping_bag_rounded, label: 'Booking'),
    _NavTab(icon: Icons.local_shipping_outlined, activeIcon: Icons.local_shipping_rounded, label: 'Dispatch'),
    _NavTab(icon: Icons.timer_outlined,          activeIcon: Icons.timer_rounded,        label: 'TimeKeeper', isTimekeeper: true),
  ];

  static const int _maxTabs = 9;
  ...
  void _handleTap(int visibleIndex, List<_NavTab> tabs) {
    ...
    if (allTabIndex == 7) {
      ...
      Navigator.push(
        context,
        PageRouteBuilder(
          pageBuilder: (context, animation, secondaryAnimation) => DispatchScreen(
            currentIndex: 7,
            chatBadgeCount: widget.chatBadgeCount,
            onNavTap: (i) {
              if (navigator.canPop()) navigator.pop();
