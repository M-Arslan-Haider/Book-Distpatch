...
// ═══════════════════════════════════════════════════════════════════════════
// app_bottom_navbar.dart  —  Style 3: Circle Bubble (Dark)
//
// Active tab: teal glowing circle behind icon.
// Inactive tabs: muted outline icons only.
          ...
          child: Column(
            ...
            children: [
              ...
              AnimatedBuilder(
                ...
                builder: (context, _) {
                  final t = _bubbleAnimations[index].value;
                  return Stack(
                    alignment: Alignment.center,
                    children: [
                      Container(
